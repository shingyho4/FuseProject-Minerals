...
{
    static KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry___uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry___uType*)::uAllocValueType(sizeof(KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry___uType), "Uno.Collections.KeyValuePair<Fuse.Entities.Mesh,Uno.Collections.List<Fuse.Entities.Entry>>", sizeof(KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry_), 0, 2);
        type->StrongRefOffsets[0] = offsetof(KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry_, _key);
        type->StrongRefOffsets[1] = offsetof(KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry_, _value);
#ifdef U_DEBUG_MEM
