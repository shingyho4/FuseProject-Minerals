...
{
    static TransformAnimatorState__Fuse_Scaling__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (TransformAnimatorState__Fuse_Scaling__uType*)::uAllocClassType(sizeof(TransformAnimatorState__Fuse_Scaling__uType), "Fuse.Animations.TransformAnimatorState<Fuse.Scaling>", ::app::Fuse::Animations::ProgressAnimatorState__typeof(), 0, 4);
        type->__fp_Disable = (void(*)(::app::Fuse::Animations::AnimatorState*))TransformAnimatorState__Fuse_Scaling__Disable;
        type->__fp_Seek = (void(*)(::app::Fuse::Animations::ProgressAnimatorState*, float, float))TransformAnimatorState__Fuse_Scaling__Seek;

        type->StrongRefOffsets[0] = offsetof(TransformAnimatorState__Fuse_Scaling, Animator_1);
        type->StrongRefOffsets[1] = offsetof(TransformAnimatorState__Fuse_Scaling, mixHandle);
        type->StrongRefOffsets[2] = offsetof(TransformAnimatorState__Fuse_Scaling, transform);
        type->StrongRefOffsets[3] = offsetof(TransformAnimatorState__Fuse_Scaling, _matAct);
#ifdef U_DEBUG_MEM
...
void TransformAnimatorState__Fuse_Scaling__Seek(TransformAnimatorState__Fuse_Scaling* __this, float progress, float strength)
{
    ...
    __this->_inSeek = true;
    ::uPtr< ::app::Fuse::Animations::TransformAnimator__Fuse_Scaling*>(__this->Animator_1)->Update(__this->Node, __this->transform);
...
void TransformAnimatorState__Fuse_Scaling___ObjInit_2(TransformAnimatorState__Fuse_Scaling* __this, ::app::Fuse::Animations::TransformAnimator__Fuse_Scaling* animator, ::app::Fuse::Animations::CreateStateParams* p)
{
    ...
    ::app::Fuse::Animations::ProgressAnimatorState___ObjInit_1(__this, (::app::Fuse::Animations::ProgressAnimator*)animator, p, ::uPtr< ::app::Fuse::Animations::TransformAnimator__Fuse_Scaling*>(animator)->Target());
    ...
    __this->_matAct = ::uNewDelegateNonVirt(::app::Uno::Action__Fuse_Transform__typeof(), (const void*)::app::Fuse::Animations::TransformAnimatorState__Fuse_Scaling__OnMatrixChanged, __this);
...
{
    TransformAnimatorState__Fuse_Scaling* inst = (::app::Fuse::Animations::TransformAnimatorState__Fuse_Scaling*)::uAllocObject(sizeof(::app::Fuse::Animations::TransformAnimatorState__Fuse_Scaling), ::app::Fuse::Animations::TransformAnimatorState__Fuse_Scaling__typeof());
