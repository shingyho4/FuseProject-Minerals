...
{
    static Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs__uType*)::uAllocClassType(sizeof(Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs__uType), "Fuse.Input.Event<Fuse.Input.PointerPressedHandler,Fuse.Input.PointerPressedArgs>", ::uObject__typeof(), 0, 2);
        type->StrongRefOffsets[0] = offsetof(Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs, _handle);
        type->StrongRefOffsets[1] = offsetof(Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs, _globalHandlers);
#ifdef U_DEBUG_MEM
...
void Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs__Raise(Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs* __this, ::app::Fuse::Input::PointerPressedArgs* args, int type, bool bubble)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = ::uNewDelegateNonVirt(::app::Uno::Action__object__object____typeof(), (const void*)::app::Fuse::Input::Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs__OnRaise, __this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = ::uNewDelegateNonVirt(::app::Uno::Action__object__object____typeof(), (const void*)::app::Fuse::Input::Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs__OnRaiseEnabled, __this);
            break;
        }
        default:
        {
