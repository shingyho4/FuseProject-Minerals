...
#include <app/Uno.Collections.SelectEnumerator__Fuse_Drawing_Border__Fuse_Dra-59fbc76b.h>
...
{
    static SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType*)::uAllocClassType(sizeof(SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType), "Uno.Collections.SelectEnumerator<Fuse.Drawing.Border,Fuse.Drawing.Contour>", ::uObject__typeof(), 3, 2);
        ...
        type->InterfaceOffsets[0] = offsetof(SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType, __interface_0);
        type->InterfaceOffsets[1] = offsetof(SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType, __interface_1);
        type->InterfaceOffsets[2] = offsetof(SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType, __interface_2);

        type->StrongRefOffsets[0] = offsetof(SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour, _source);
        type->StrongRefOffsets[1] = offsetof(SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour, _select);
#ifdef U_DEBUG_MEM
...
{
    SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour* inst = (::app::Uno::Collections::SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour*)::uAllocObject(sizeof(::app::Uno::Collections::SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour), ::app::Uno::Collections::SelectEnumerator__Fuse_Drawing_Border__Fuse_Drawing_Contour__typeof());
