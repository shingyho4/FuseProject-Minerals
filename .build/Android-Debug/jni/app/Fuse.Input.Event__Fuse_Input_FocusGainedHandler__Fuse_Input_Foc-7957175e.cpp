...
{
    static Event__Fuse_Input_FocusGainedHandler__Fuse_Input_FocusGainedArgs__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (Event__Fuse_Input_FocusGainedHandler__Fuse_Input_FocusGainedArgs__uType*)::uAllocClassType(sizeof(Event__Fuse_Input_FocusGainedHandler__Fuse_Input_FocusGainedArgs__uType), "Fuse.Input.Event<Fuse.Input.FocusGainedHandler,Fuse.Input.FocusGainedArgs>", ::uObject__typeof(), 0, 2);
        type->StrongRefOffsets[0] = offsetof(Event__Fuse_Input_FocusGainedHandler__Fuse_Input_FocusGainedArgs, _handle);
        type->StrongRefOffsets[1] = offsetof(Event__Fuse_Input_FocusGainedHandler__Fuse_Input_FocusGainedArgs, _globalHandlers);
#ifdef U_DEBUG_MEM
...
void Event__Fuse_Input_FocusGainedHandler__Fuse_Input_FocusGainedArgs__Raise(Event__Fuse_Input_FocusGainedHandler__Fuse_Input_FocusGainedArgs* __this, ::app::Fuse::Input::FocusGainedArgs* args, int type, bool bubble)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = ::uNewDelegateNonVirt(::app::Uno::Action__object__object____typeof(), (const void*)::app::Fuse::Input::Event__Fuse_Input_FocusGainedHandler__Fuse_Input_FocusGainedArgs__OnRaise, __this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = ::uNewDelegateNonVirt(::app::Uno::Action__object__object____typeof(), (const void*)::app::Fuse::Input::Event__Fuse_Input_FocusGainedHandler__Fuse_Input_FocusGainedArgs__OnRaiseEnabled, __this);
            break;
        }
        default:
        {
