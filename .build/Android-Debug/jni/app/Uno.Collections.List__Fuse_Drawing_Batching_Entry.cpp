...
{
    static List__Fuse_Drawing_Batching_Entry__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (List__Fuse_Drawing_Batching_Entry__uType*)::uAllocClassType(sizeof(List__Fuse_Drawing_Batching_Entry__uType), "Uno.Collections.List<Fuse.Drawing.Batching.Entry>", ::uObject__typeof(), 0, 1);
        type->StrongRefOffsets[0] = offsetof(List__Fuse_Drawing_Batching_Entry, _data);
#ifdef U_DEBUG_MEM
...
{
    List__Fuse_Drawing_Batching_Entry* inst = (::app::Uno::Collections::List__Fuse_Drawing_Batching_Entry*)::uAllocObject(sizeof(::app::Uno::Collections::List__Fuse_Drawing_Batching_Entry), ::app::Uno::Collections::List__Fuse_Drawing_Batching_Entry__typeof());
    inst->_ObjInit();
    return inst;
}
