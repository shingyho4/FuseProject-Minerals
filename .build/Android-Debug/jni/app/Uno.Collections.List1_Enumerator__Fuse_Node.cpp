...
{
    static List1_Enumerator__Fuse_Node__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (List1_Enumerator__Fuse_Node__uType*)::uAllocValueType(sizeof(List1_Enumerator__Fuse_Node__uType), "Uno.Collections.List1_Enumerator<Fuse.Node>", sizeof(List1_Enumerator__Fuse_Node), 2, 2);
        type->__interface_0.__fp_Dispose = (void(*)(void*))List1_Enumerator__Fuse_Node__Dispose;
        type->__interface_1.__fp_MoveNext = (bool(*)(void*))List1_Enumerator__Fuse_Node__MoveNext;

        type->Implements[0] = ::app::Uno::IDisposable__typeof();
        type->Implements[1] = ::app::Uno::Collections::IEnumerator__typeof();

        type->InterfaceOffsets[0] = offsetof(List1_Enumerator__Fuse_Node__uType, __interface_0);
        type->InterfaceOffsets[1] = offsetof(List1_Enumerator__Fuse_Node__uType, __interface_1);

        type->StrongRefOffsets[0] = offsetof(List1_Enumerator__Fuse_Node, _source);
        type->StrongRefOffsets[1] = offsetof(List1_Enumerator__Fuse_Node, _current);
#ifdef U_DEBUG_MEM
