...
{
    static BasicTheme_Fuse_Elements_Element_float_Opacity_Property__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (BasicTheme_Fuse_Elements_Element_float_Opacity_Property__uType*)::uAllocClassType(sizeof(BasicTheme_Fuse_Elements_Element_float_Opacity_Property__uType), "Fuse.BasicTheme.BasicTheme.Fuse_Elements_Element_float_Opacity_Property", ::app::Uno::UX::Property__float__typeof(), 0, 1);
        type->__fp_OnGet = (float(*)(::app::Uno::UX::Property__float*))BasicTheme_Fuse_Elements_Element_float_Opacity_Property__OnGet;
        type->__fp_OnSet = (void(*)(::app::Uno::UX::Property__float*, float))BasicTheme_Fuse_Elements_Element_float_Opacity_Property__OnSet;

        type->StrongRefOffsets[0] = offsetof(BasicTheme_Fuse_Elements_Element_float_Opacity_Property, _obj);
#ifdef U_DEBUG_MEM
...
{
    BasicTheme_Fuse_Elements_Element_float_Opacity_Property* inst = (::app::Fuse::BasicTheme::BasicTheme_Fuse_Elements_Element_float_Opacity_Property*)::uAllocObject(sizeof(::app::Fuse::BasicTheme::BasicTheme_Fuse_Elements_Element_float_Opacity_Property), ::app::Fuse::BasicTheme::BasicTheme_Fuse_Elements_Element_float_Opacity_Property__typeof());
    inst->_ObjInit_2(obj);
    return inst;
}
