...
{
    static Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs__uType*)::uAllocClassType(sizeof(Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs__uType), "Fuse.Input.Event<Fuse.Input.PointerWheelMovedHandler,Fuse.Input.PointerWheelMovedArgs>", ::uObject__typeof(), 0, 2);
        type->StrongRefOffsets[0] = offsetof(Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs, _handle);
        type->StrongRefOffsets[1] = offsetof(Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs, _globalHandlers);
#ifdef U_DEBUG_MEM
...
void Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs__Raise(Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs* __this, ::app::Fuse::Input::PointerWheelMovedArgs* args, int type, bool bubble)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = ::uNewDelegateNonVirt(::app::Uno::Action__object__object____typeof(), (const void*)::app::Fuse::Input::Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs__OnRaise, __this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = ::uNewDelegateNonVirt(::app::Uno::Action__object__object____typeof(), (const void*)::app::Fuse::Input::Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs__OnRaiseEnabled, __this);
            break;
        }
        default:
        {
