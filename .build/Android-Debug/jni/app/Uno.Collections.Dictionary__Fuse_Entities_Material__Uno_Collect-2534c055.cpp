...
{
    static Dictionary__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry___uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (Dictionary__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry___uType*)::uAllocClassType(sizeof(Dictionary__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry___uType), "Uno.Collections.Dictionary<Fuse.Entities.Material,Uno.Collections.List<Fuse.Entities.Entry>>", ::uObject__typeof(), 0, 1);
        type->StrongRefOffsets[0] = offsetof(Dictionary__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry_, _buckets);
#ifdef U_DEBUG_MEM
...
{
    Dictionary__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry_* inst = (::app::Uno::Collections::Dictionary__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry_*)::uAllocObject(sizeof(::app::Uno::Collections::Dictionary__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry_), ::app::Uno::Collections::Dictionary__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry___typeof());
    inst->_ObjInit();
    return inst;
}
