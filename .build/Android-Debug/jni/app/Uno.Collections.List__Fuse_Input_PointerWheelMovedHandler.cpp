...
{
    static List__Fuse_Input_PointerWheelMovedHandler__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (List__Fuse_Input_PointerWheelMovedHandler__uType*)::uAllocClassType(sizeof(List__Fuse_Input_PointerWheelMovedHandler__uType), "Uno.Collections.List<Fuse.Input.PointerWheelMovedHandler>", ::uObject__typeof(), 0, 1);
        type->StrongRefOffsets[0] = offsetof(List__Fuse_Input_PointerWheelMovedHandler, _data);
#ifdef U_DEBUG_MEM
...
{
    List__Fuse_Input_PointerWheelMovedHandler* inst = (::app::Uno::Collections::List__Fuse_Input_PointerWheelMovedHandler*)::uAllocObject(sizeof(::app::Uno::Collections::List__Fuse_Input_PointerWheelMovedHandler), ::app::Uno::Collections::List__Fuse_Input_PointerWheelMovedHandler__typeof());
    inst->_ObjInit();
    return inst;
}
