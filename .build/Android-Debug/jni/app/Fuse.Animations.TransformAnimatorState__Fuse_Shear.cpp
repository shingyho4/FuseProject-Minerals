...
{
    static TransformAnimatorState__Fuse_Shear__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (TransformAnimatorState__Fuse_Shear__uType*)::uAllocClassType(sizeof(TransformAnimatorState__Fuse_Shear__uType), "Fuse.Animations.TransformAnimatorState<Fuse.Shear>", ::app::Fuse::Animations::ProgressAnimatorState__typeof(), 0, 4);
        type->__fp_Disable = (void(*)(::app::Fuse::Animations::AnimatorState*))TransformAnimatorState__Fuse_Shear__Disable;
        type->__fp_Seek = (void(*)(::app::Fuse::Animations::ProgressAnimatorState*, float, float))TransformAnimatorState__Fuse_Shear__Seek;

        type->StrongRefOffsets[0] = offsetof(TransformAnimatorState__Fuse_Shear, Animator_1);
        type->StrongRefOffsets[1] = offsetof(TransformAnimatorState__Fuse_Shear, mixHandle);
        type->StrongRefOffsets[2] = offsetof(TransformAnimatorState__Fuse_Shear, transform);
        type->StrongRefOffsets[3] = offsetof(TransformAnimatorState__Fuse_Shear, _matAct);
#ifdef U_DEBUG_MEM
...
void TransformAnimatorState__Fuse_Shear__Seek(TransformAnimatorState__Fuse_Shear* __this, float progress, float strength)
{
    ...
    __this->_inSeek = true;
    ::uPtr< ::app::Fuse::Animations::TransformAnimator__Fuse_Shear*>(__this->Animator_1)->Update(__this->Node, __this->transform);
...
void TransformAnimatorState__Fuse_Shear___ObjInit_2(TransformAnimatorState__Fuse_Shear* __this, ::app::Fuse::Animations::TransformAnimator__Fuse_Shear* animator, ::app::Fuse::Animations::CreateStateParams* p)
{
    ...
    ::app::Fuse::Animations::ProgressAnimatorState___ObjInit_1(__this, (::app::Fuse::Animations::ProgressAnimator*)animator, p, ::uPtr< ::app::Fuse::Animations::TransformAnimator__Fuse_Shear*>(animator)->Target());
    ...
    __this->_matAct = ::uNewDelegateNonVirt(::app::Uno::Action__Fuse_Transform__typeof(), (const void*)::app::Fuse::Animations::TransformAnimatorState__Fuse_Shear__OnMatrixChanged, __this);
...
{
    TransformAnimatorState__Fuse_Shear* inst = (::app::Fuse::Animations::TransformAnimatorState__Fuse_Shear*)::uAllocObject(sizeof(::app::Fuse::Animations::TransformAnimatorState__Fuse_Shear), ::app::Fuse::Animations::TransformAnimatorState__Fuse_Shear__typeof());
