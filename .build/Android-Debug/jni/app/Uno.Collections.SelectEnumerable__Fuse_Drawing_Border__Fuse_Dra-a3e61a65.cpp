...
{
    static SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType*)::uAllocClassType(sizeof(SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType), "Uno.Collections.SelectEnumerable<Fuse.Drawing.Border,Fuse.Drawing.Contour>", ::uObject__typeof(), 1, 2);
        ...
        type->InterfaceOffsets[0] = offsetof(SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour__uType, __interface_0);

        type->StrongRefOffsets[0] = offsetof(SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour, _source);
        type->StrongRefOffsets[1] = offsetof(SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour, _select);
#ifdef U_DEBUG_MEM
...
{
    SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour* inst = (::app::Uno::Collections::SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour*)::uAllocObject(sizeof(::app::Uno::Collections::SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour), ::app::Uno::Collections::SelectEnumerable__Fuse_Drawing_Border__Fuse_Drawing_Contour__typeof());
