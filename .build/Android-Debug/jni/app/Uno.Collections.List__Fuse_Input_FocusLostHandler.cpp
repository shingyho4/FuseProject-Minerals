...
{
    static List__Fuse_Input_FocusLostHandler__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (List__Fuse_Input_FocusLostHandler__uType*)::uAllocClassType(sizeof(List__Fuse_Input_FocusLostHandler__uType), "Uno.Collections.List<Fuse.Input.FocusLostHandler>", ::uObject__typeof(), 0, 1);
        type->StrongRefOffsets[0] = offsetof(List__Fuse_Input_FocusLostHandler, _data);
#ifdef U_DEBUG_MEM
...
{
    List__Fuse_Input_FocusLostHandler* inst = (::app::Uno::Collections::List__Fuse_Input_FocusLostHandler*)::uAllocObject(sizeof(::app::Uno::Collections::List__Fuse_Input_FocusLostHandler), ::app::Uno::Collections::List__Fuse_Input_FocusLostHandler__typeof());
    inst->_ObjInit();
    return inst;
}
