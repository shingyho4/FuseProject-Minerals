...
{
    static List1_Enumerator__Fuse_Animations_Animator__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (List1_Enumerator__Fuse_Animations_Animator__uType*)::uAllocValueType(sizeof(List1_Enumerator__Fuse_Animations_Animator__uType), "Uno.Collections.List1_Enumerator<Fuse.Animations.Animator>", sizeof(List1_Enumerator__Fuse_Animations_Animator), 2, 2);
        type->__interface_0.__fp_Dispose = (void(*)(void*))List1_Enumerator__Fuse_Animations_Animator__Dispose;
        type->__interface_1.__fp_MoveNext = (bool(*)(void*))List1_Enumerator__Fuse_Animations_Animator__MoveNext;

        type->Implements[0] = ::app::Uno::IDisposable__typeof();
        type->Implements[1] = ::app::Uno::Collections::IEnumerator__typeof();

        type->InterfaceOffsets[0] = offsetof(List1_Enumerator__Fuse_Animations_Animator__uType, __interface_0);
        type->InterfaceOffsets[1] = offsetof(List1_Enumerator__Fuse_Animations_Animator__uType, __interface_1);

        type->StrongRefOffsets[0] = offsetof(List1_Enumerator__Fuse_Animations_Animator, _source);
        type->StrongRefOffsets[1] = offsetof(List1_Enumerator__Fuse_Animations_Animator, _current);
#ifdef U_DEBUG_MEM
