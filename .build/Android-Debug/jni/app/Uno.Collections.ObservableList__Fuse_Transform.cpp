...
{
    static ObservableList__Fuse_Transform__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (ObservableList__Fuse_Transform__uType*)::uAllocClassType(sizeof(ObservableList__Fuse_Transform__uType), "Uno.Collections.ObservableList<Fuse.Transform>", ::uObject__typeof(), 2, 3);
        ...
        type->InterfaceOffsets[0] = offsetof(ObservableList__Fuse_Transform__uType, __interface_0);
        type->InterfaceOffsets[1] = offsetof(ObservableList__Fuse_Transform__uType, __interface_1);

        type->StrongRefOffsets[0] = offsetof(ObservableList__Fuse_Transform, items);
        type->StrongRefOffsets[1] = offsetof(ObservableList__Fuse_Transform, added);
        type->StrongRefOffsets[2] = offsetof(ObservableList__Fuse_Transform, removed);
#ifdef U_DEBUG_MEM
...
{
    ObservableList__Fuse_Transform* inst = (::app::Uno::Collections::ObservableList__Fuse_Transform*)::uAllocObject(sizeof(::app::Uno::Collections::ObservableList__Fuse_Transform), ::app::Uno::Collections::ObservableList__Fuse_Transform__typeof());
