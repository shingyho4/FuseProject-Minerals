...
{
    static Event__Fuse_Input_KeyReleasedHandler__Fuse_Input_KeyReleasedArgs__uType* type;

    if (::uEnterCriticalIfNull(&type))
    {
        type = (Event__Fuse_Input_KeyReleasedHandler__Fuse_Input_KeyReleasedArgs__uType*)::uAllocClassType(sizeof(Event__Fuse_Input_KeyReleasedHandler__Fuse_Input_KeyReleasedArgs__uType), "Fuse.Input.Event<Fuse.Input.KeyReleasedHandler,Fuse.Input.KeyReleasedArgs>", ::uObject__typeof(), 0, 2);
        type->StrongRefOffsets[0] = offsetof(Event__Fuse_Input_KeyReleasedHandler__Fuse_Input_KeyReleasedArgs, _handle);
        type->StrongRefOffsets[1] = offsetof(Event__Fuse_Input_KeyReleasedHandler__Fuse_Input_KeyReleasedArgs, _globalHandlers);
#ifdef U_DEBUG_MEM
...
void Event__Fuse_Input_KeyReleasedHandler__Fuse_Input_KeyReleasedArgs__Raise(Event__Fuse_Input_KeyReleasedHandler__Fuse_Input_KeyReleasedArgs* __this, ::app::Fuse::Input::KeyReleasedArgs* args, int type, bool bubble)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = ::uNewDelegateNonVirt(::app::Uno::Action__object__object____typeof(), (const void*)::app::Fuse::Input::Event__Fuse_Input_KeyReleasedHandler__Fuse_Input_KeyReleasedArgs__OnRaise, __this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = ::uNewDelegateNonVirt(::app::Uno::Action__object__object____typeof(), (const void*)::app::Fuse::Input::Event__Fuse_Input_KeyReleasedHandler__Fuse_Input_KeyReleasedArgs__OnRaiseEnabled, __this);
            break;
        }
        default:
        {
