...
struct IList__Fuse_Triggers_State
{
    ...
    static ::app::Fuse::Triggers::State* Item(::uObject* __this, int index) { return ((IList__Fuse_Triggers_State*)uGetInterfacePtr(__this, IList__Fuse_Triggers_State__typeof()))->__fp_get_Item((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), index); }
};
