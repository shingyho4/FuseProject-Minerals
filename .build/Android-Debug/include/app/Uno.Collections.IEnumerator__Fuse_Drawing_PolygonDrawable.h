...
struct IEnumerator__Fuse_Drawing_PolygonDrawable
{
    ...
    static ::app::Fuse::Drawing::PolygonDrawable* Current(::uObject* __this) { return ((IEnumerator__Fuse_Drawing_PolygonDrawable*)uGetInterfacePtr(__this, IEnumerator__Fuse_Drawing_PolygonDrawable__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
