...
struct IList__Fuse_Transform
{
    ...
    static ::app::Fuse::Transform* Item(::uObject* __this, int index) { return ((IList__Fuse_Transform*)uGetInterfacePtr(__this, IList__Fuse_Transform__typeof()))->__fp_get_Item((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), index); }
};
