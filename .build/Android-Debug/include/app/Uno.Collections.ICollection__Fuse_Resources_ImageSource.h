...
struct ICollection__Fuse_Resources_ImageSource
{
    ...
    static void Add(::uObject* __this, ::app::Fuse::Resources::ImageSource* item) { ((ICollection__Fuse_Resources_ImageSource*)uGetInterfacePtr(__this, ICollection__Fuse_Resources_ImageSource__typeof()))->__fp_Add((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), item); }
};
