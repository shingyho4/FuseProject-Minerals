...
#ifndef __APP_FUSE_DRAWING_NON_CONSECUTIVE_EXTENSION_H__
#define __APP_FUSE_DRAWING_NON_CONSECUTIVE_EXTENSION_H__
...
struct NonConsecutiveExtension__uType : ::uClassType
{
};
