...
struct IHide
{
    ...
    static void Hide(::uObject* __this) { ((IHide*)uGetInterfacePtr(__this, IHide__typeof()))->__fp_Hide((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
