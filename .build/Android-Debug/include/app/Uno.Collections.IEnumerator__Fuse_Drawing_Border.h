...
struct IEnumerator__Fuse_Drawing_Border
{
    ...
    static ::app::Fuse::Drawing::Border* Current(::uObject* __this) { return ((IEnumerator__Fuse_Drawing_Border*)uGetInterfacePtr(__this, IEnumerator__Fuse_Drawing_Border__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
