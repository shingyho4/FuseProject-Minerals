...
struct IEnumerator__Fuse_Triggers_State
{
    ...
    static ::app::Fuse::Triggers::State* Current(::uObject* __this) { return ((IEnumerator__Fuse_Triggers_State*)uGetInterfacePtr(__this, IEnumerator__Fuse_Triggers_State__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
