...
struct IList__Uno_UX_ITemplate
{
    ...
    static ::uObject* Item(::uObject* __this, int index) { return ((IList__Uno_UX_ITemplate*)uGetInterfacePtr(__this, IList__Uno_UX_ITemplate__typeof()))->__fp_get_Item((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), index); }
};
