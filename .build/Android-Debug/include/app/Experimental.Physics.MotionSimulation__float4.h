...
inline ::app::Uno::Float4 MotionSimulation__float4::Position(::uObject* __this) { return ((MotionSimulation__float4*)uGetInterfacePtr(__this, MotionSimulation__float4__typeof()))->__fp_get_Position((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
inline void MotionSimulation__float4::Position(::uObject* __this, ::app::Uno::Float4 value) { ((MotionSimulation__float4*)uGetInterfacePtr(__this, MotionSimulation__float4__typeof()))->__fp_set_Position((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), value); }
