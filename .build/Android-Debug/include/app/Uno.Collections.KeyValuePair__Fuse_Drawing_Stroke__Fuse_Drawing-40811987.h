...
#ifndef __APP_UNO_COLLECTIONS_KEY_VALUE_PAIR__FUSE_DRAWING_STROKE__FUSE_DRAWING_40811987_H__
#define __APP_UNO_COLLECTIONS_KEY_VALUE_PAIR__FUSE_DRAWING_STROKE__FUSE_DRAWING_40811987_H__
...
struct KeyValuePair__Fuse_Drawing_Stroke__Fuse_Drawing_PolygonFiller__uType : ::uValueType
{
};
...
struct KeyValuePair__Fuse_Drawing_Stroke__Fuse_Drawing_PolygonFiller
{
    ...
    KeyValuePair__Fuse_Drawing_Stroke__Fuse_Drawing_PolygonFiller& operator =(const KeyValuePair__Fuse_Drawing_Stroke__Fuse_Drawing_PolygonFiller& copy)
    {
        ::uCopyValue(this, KeyValuePair__Fuse_Drawing_Stroke__Fuse_Drawing_PolygonFiller__typeof(), &copy);
        return *this;
    }
};
