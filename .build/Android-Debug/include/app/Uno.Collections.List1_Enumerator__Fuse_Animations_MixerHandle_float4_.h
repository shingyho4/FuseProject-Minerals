...
struct List1_Enumerator__Fuse_Animations_MixerHandle_float4___uType : ::uValueType
{
...
struct List1_Enumerator__Fuse_Animations_MixerHandle_float4_
{
    ...
    List1_Enumerator__Fuse_Animations_MixerHandle_float4_& operator =(const List1_Enumerator__Fuse_Animations_MixerHandle_float4_& copy)
    {
        ::uCopyValue(this, List1_Enumerator__Fuse_Animations_MixerHandle_float4___typeof(), &copy);
        return *this;
    }
};
