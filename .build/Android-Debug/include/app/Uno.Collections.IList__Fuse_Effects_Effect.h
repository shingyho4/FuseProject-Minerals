...
struct IList__Fuse_Effects_Effect
{
    ...
    static ::app::Fuse::Effects::Effect* Item(::uObject* __this, int index) { return ((IList__Fuse_Effects_Effect*)uGetInterfacePtr(__this, IList__Fuse_Effects_Effect__typeof()))->__fp_get_Item((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), index); }
};
