...
namespace app { namespace Fuse { namespace Input { struct Event__Fuse_Input_PointerEnteredHandler__Fuse_Input_PointerEnteredArgs; } } }
namespace app { namespace Fuse { namespace Input { struct Event__Fuse_Input_PointerLeftHandler__Fuse_Input_PointerLeftArgs; } } }
namespace app { namespace Fuse { namespace Input { struct Event__Fuse_Input_PointerMovedHandler__Fuse_Input_PointerMovedArgs; } } }
namespace app { namespace Fuse { namespace Input { struct Event__Fuse_Input_PointerPressedHandler__Fuse_Input_PointerPressedArgs; } } }
namespace app { namespace Fuse { namespace Input { struct Event__Fuse_Input_PointerReleasedHandler__Fuse_Input_PointerReleasedArgs; } } }
namespace app { namespace Fuse { namespace Input { struct Event__Fuse_Input_PointerWheelMovedHandler__Fuse_Input_PointerWheelMovedArgs; } } }
