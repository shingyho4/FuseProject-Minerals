...
#ifndef __APP_UNO_GRAPHICS_VERTEX_ATTRIBUTE_TYPE_HELPERS_H__
#define __APP_UNO_GRAPHICS_VERTEX_ATTRIBUTE_TYPE_HELPERS_H__
...
struct VertexAttributeTypeHelpers__uType : ::uClassType
{
};
