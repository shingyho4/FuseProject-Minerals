...
struct IEnumerator__Fuse_Elements_Element
{
    ...
    static ::app::Fuse::Elements::Element* Current(::uObject* __this) { return ((IEnumerator__Fuse_Elements_Element*)uGetInterfacePtr(__this, IEnumerator__Fuse_Elements_Element__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
