...
struct Dictionary2_Bucket__string__object__uType : ::uValueType
{
};
...
struct Dictionary2_Bucket__string__object
{
    ...
    Dictionary2_Bucket__string__object& operator =(const Dictionary2_Bucket__string__object& copy)
    {
        ::uCopyValue(this, Dictionary2_Bucket__string__object__typeof(), &copy);
        return *this;
    }
};
