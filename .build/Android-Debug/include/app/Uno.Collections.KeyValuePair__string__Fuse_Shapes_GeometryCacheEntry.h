...
struct KeyValuePair__string__Fuse_Shapes_GeometryCacheEntry__uType : ::uValueType
{
};
...
struct KeyValuePair__string__Fuse_Shapes_GeometryCacheEntry
{
    ...
    KeyValuePair__string__Fuse_Shapes_GeometryCacheEntry& operator =(const KeyValuePair__string__Fuse_Shapes_GeometryCacheEntry& copy)
    {
        ::uCopyValue(this, KeyValuePair__string__Fuse_Shapes_GeometryCacheEntry__typeof(), &copy);
        return *this;
    }
};
