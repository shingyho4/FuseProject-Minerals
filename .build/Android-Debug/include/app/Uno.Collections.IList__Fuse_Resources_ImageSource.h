...
#ifndef __APP_UNO_COLLECTIONS_I_LIST__FUSE_RESOURCES_IMAGE_SOURCE_H__
#define __APP_UNO_COLLECTIONS_I_LIST__FUSE_RESOURCES_IMAGE_SOURCE_H__
...
struct IList__Fuse_Resources_ImageSource
{
};
