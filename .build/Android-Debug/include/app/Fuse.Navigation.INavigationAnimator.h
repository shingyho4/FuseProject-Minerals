...
struct INavigationAnimator
{
    ...
    static void Update(::uObject* __this, double progress, double prevProgress) { ((INavigationAnimator*)uGetInterfacePtr(__this, INavigationAnimator__typeof()))->__fp_Update((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), progress, prevProgress); }
};
