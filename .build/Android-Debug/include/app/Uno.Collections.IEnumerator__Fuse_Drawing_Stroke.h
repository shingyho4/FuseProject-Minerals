...
struct IEnumerator__Fuse_Drawing_Stroke
{
    ...
    static ::app::Fuse::Drawing::Stroke* Current(::uObject* __this) { return ((IEnumerator__Fuse_Drawing_Stroke*)uGetInterfacePtr(__this, IEnumerator__Fuse_Drawing_Stroke__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
