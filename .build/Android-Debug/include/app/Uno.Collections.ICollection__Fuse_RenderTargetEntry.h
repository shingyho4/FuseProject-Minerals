...
struct ICollection__Fuse_RenderTargetEntry
{
    ...
    static int Count(::uObject* __this) { return ((ICollection__Fuse_RenderTargetEntry*)uGetInterfacePtr(__this, ICollection__Fuse_RenderTargetEntry__typeof()))->__fp_get_Count((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
