...
#ifndef __APP_FUSE_DRAWING_BLEND_MODE_HELPERS_H__
#define __APP_FUSE_DRAWING_BLEND_MODE_HELPERS_H__
...
extern ::uStaticStrong< ::uString*> BlendModeHelpers___invalidBlendMode;

struct BlendModeHelpers__uType : ::uClassType
{
};
