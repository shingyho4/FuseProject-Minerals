...
struct IShow
{
    ...
    static void Show(::uObject* __this) { ((IShow*)uGetInterfacePtr(__this, IShow__typeof()))->__fp_Show((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
