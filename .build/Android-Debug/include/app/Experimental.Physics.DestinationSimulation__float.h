...
struct DestinationSimulation__float
{
    ...
    static float Destination(::uObject* __this) { return ((DestinationSimulation__float*)uGetInterfacePtr(__this, DestinationSimulation__float__typeof()))->__fp_get_Destination((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
    static void Destination(::uObject* __this, float value) { ((DestinationSimulation__float*)uGetInterfacePtr(__this, DestinationSimulation__float__typeof()))->__fp_set_Destination((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), value); }
};
