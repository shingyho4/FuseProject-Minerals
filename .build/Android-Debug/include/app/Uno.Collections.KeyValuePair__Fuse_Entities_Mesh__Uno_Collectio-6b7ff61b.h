...
#ifndef __APP_UNO_COLLECTIONS_KEY_VALUE_PAIR__FUSE_ENTITIES_MESH__UNO_COLLECTIO_6B7FF61B_H__
#define __APP_UNO_COLLECTIONS_KEY_VALUE_PAIR__FUSE_ENTITIES_MESH__UNO_COLLECTIO_6B7FF61B_H__
...
struct KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry_;

struct KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry___uType : ::uValueType
{
};
...
struct KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry_
{
    ...
    void _ObjInit(::app::Fuse::Entities::Mesh* key, ::app::Uno::Collections::List__Fuse_Entities_Entry* value) { KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry____ObjInit(this, key, value); }
    ::app::Fuse::Entities::Mesh* Key() { return KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry___get_Key(this); }
    ::app::Uno::Collections::List__Fuse_Entities_Entry* Value() { return KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry___get_Value(this); }

    KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry_& operator =(const KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry_& copy)
    {
        ::uCopyValue(this, KeyValuePair__Fuse_Entities_Mesh__Uno_Collections_List_Fuse_Entities_Entry___typeof(), &copy);
        return *this;
    }
};
