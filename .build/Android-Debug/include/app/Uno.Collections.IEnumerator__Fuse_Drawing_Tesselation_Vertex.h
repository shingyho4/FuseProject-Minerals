...
struct IEnumerator__Fuse_Drawing_Tesselation_Vertex
{
    ...
    static ::app::Fuse::Drawing::Tesselation::Vertex* Current(::uObject* __this) { return ((IEnumerator__Fuse_Drawing_Tesselation_Vertex*)uGetInterfacePtr(__this, IEnumerator__Fuse_Drawing_Tesselation_Vertex__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
