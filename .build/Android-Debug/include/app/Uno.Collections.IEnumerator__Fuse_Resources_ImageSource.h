...
struct IEnumerator__Fuse_Resources_ImageSource
{
    ...
    static ::app::Fuse::Resources::ImageSource* Current(::uObject* __this) { return ((IEnumerator__Fuse_Resources_ImageSource*)uGetInterfacePtr(__this, IEnumerator__Fuse_Resources_ImageSource__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
