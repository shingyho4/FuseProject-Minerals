...
struct ICollapse
{
    ...
    static void Collapse(::uObject* __this) { ((ICollapse*)uGetInterfacePtr(__this, ICollapse__typeof()))->__fp_Collapse((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
