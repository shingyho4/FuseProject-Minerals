...
struct ITemplate
{
    ...
    static bool Apply(::uObject* __this, ::uObject* obj) { return ((ITemplate*)uGetInterfacePtr(__this, ITemplate__typeof()))->__fp_Apply((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), obj); }
};
