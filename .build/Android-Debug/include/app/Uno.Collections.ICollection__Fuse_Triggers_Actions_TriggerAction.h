...
struct ICollection__Fuse_Triggers_Actions_TriggerAction
{
    ...
    static void Add(::uObject* __this, ::app::Fuse::Triggers::Actions::TriggerAction* item) { ((ICollection__Fuse_Triggers_Actions_TriggerAction*)uGetInterfacePtr(__this, ICollection__Fuse_Triggers_Actions_TriggerAction__typeof()))->__fp_Add((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0), item); }
};
