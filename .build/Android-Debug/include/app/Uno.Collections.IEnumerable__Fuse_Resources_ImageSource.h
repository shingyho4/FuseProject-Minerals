...
struct IEnumerable__Fuse_Resources_ImageSource
{
    ...
    static ::uObject* GetEnumerator(::uObject* __this) { return ((IEnumerable__Fuse_Resources_ImageSource*)uGetInterfacePtr(__this, IEnumerable__Fuse_Resources_ImageSource__typeof()))->__fp_GetEnumerator((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
