...
#ifndef __APP_UNO_COLLECTIONS_KEY_VALUE_PAIR__FUSE_ENTITIES_MATERIAL__UNO_COLLE_B20DF26B_H__
#define __APP_UNO_COLLECTIONS_KEY_VALUE_PAIR__FUSE_ENTITIES_MATERIAL__UNO_COLLE_B20DF26B_H__
...
struct KeyValuePair__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry___uType : ::uValueType
{
};
...
struct KeyValuePair__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry_
{
    ...
    KeyValuePair__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry_& operator =(const KeyValuePair__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry_& copy)
    {
        ::uCopyValue(this, KeyValuePair__Fuse_Entities_Material__Uno_Collections_List_Fuse_Entities_Entry___typeof(), &copy);
        return *this;
    }
};
