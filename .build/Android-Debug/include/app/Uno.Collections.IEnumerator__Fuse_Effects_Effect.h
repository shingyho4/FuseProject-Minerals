...
struct IEnumerator__Fuse_Effects_Effect
{
    ...
    static ::app::Fuse::Effects::Effect* Current(::uObject* __this) { return ((IEnumerator__Fuse_Effects_Effect*)uGetInterfacePtr(__this, IEnumerator__Fuse_Effects_Effect__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeValue ? sizeof(::uObject) : 0)); }
};
