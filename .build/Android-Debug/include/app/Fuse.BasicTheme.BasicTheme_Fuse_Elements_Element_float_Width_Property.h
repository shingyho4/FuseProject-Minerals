...
#ifndef __APP_FUSE_BASIC_THEME_BASIC_THEME_FUSE_ELEMENTS_ELEMENT_FLOAT_WIDTH_PROPERTY_H__
#define __APP_FUSE_BASIC_THEME_BASIC_THEME_FUSE_ELEMENTS_ELEMENT_FLOAT_WIDTH_PROPERTY_H__
...
struct BasicTheme_Fuse_Elements_Element_float_Width_Property;

struct BasicTheme_Fuse_Elements_Element_float_Width_Property__uType : ::app::Uno::UX::Property__float__uType
{
};
...
struct BasicTheme_Fuse_Elements_Element_float_Width_Property : ::app::Uno::UX::Property__float
{
    ::uStrong< ::app::Fuse::Elements::Element*> _obj;

    void _ObjInit_2(::app::Fuse::Elements::Element* obj) { BasicTheme_Fuse_Elements_Element_float_Width_Property___ObjInit_2(this, obj); }
};
